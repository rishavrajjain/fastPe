        ...
        <div class="container-fluid" data-aos="fade-up">
          <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-6 pt-3 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
              <h1>Fast Pe</h1>
              <h2>Fast Pe is a seamless way to accept payments with a custom-branded online store,Take your store online instantly with zero coding.Tranfer money to other people and also create invoices for your business.</h2>
              <br></br>
              <h6 style={{color:'white'}}>Powered by <a href="https://www.rapyd.net/">Rapyd</a></h6>
        ...
        <div class="row">
          <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column ">
            ...
            <div class="icon-box-home mt-5" data-aos="fade-up" data-aos-delay="400">
              ...
              <p>User friendly app and Payment security by Rapyd</p>
            </div>
          </div>
